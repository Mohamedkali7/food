    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li class="nav-item">
            <a href="http://localhost/foodie-master%20-%20Copy/Admin/" class="navbar-link" data-nav-link>Home</a>
          </li>
          ...
          <li class="nav-item">
            <a href="login.php" class="navbar-link" data-nav-link>members</a>
          </li>
      ...
      <div class="header-btn-group">
        <button class="search-btn" aria-label="Search" data-search-btn>
          <ion-icon name="search-outline"></ion-icon>
             ...
             <a href="reservation.php">  <button class="btn btn-hover"> Reservation</button>Reservation</a>
      ...
      <section class="hero" id="home" style="background-image: url('./assets/images/hero-bg.jpg')">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <a href="reservation.php"><button class="btn">Book A Table</button></a>
      ...
      <section class="section section-divider gray about" id="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <a href="orders.php"><button class="btn btn-hover">Order Now</button></a>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  ...
                  <a href="orders.php"> <button class="btn food-menu-btn">Order Now</button></a>
                </div>
    ...
    <div class="footer-top" style="background-image: url('./assets/images/footer-illustration.png')">
      <div class="container">
        ...
        <form action="" method="POST" class="footer-form">
          ...
          <a href= <?php echo"reservation.php";?> class="footer-list-title">Book a Table</a>
